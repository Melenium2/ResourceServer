...
// 1)Если когда то понадобиться работать на скорость а не на результат,
...
// 2) С использованием Redis. Брать таск и возвращать токен. И делать таск в
// горутине. Как только таск доделан класть в редис с TTL. На применой стороне
// Сделать функцию которая будет делать запрос в редис. Если данные есть то возвращает
// их. Иначе будет ошибка и значит надо подождать.
